    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200 font-roboto">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-4">
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">Menu</p>
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">Transaksi</p>

                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    ...
                    <span class="mx-3">Penerimaan</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                href="#">
                    ...
                    <span class="mx-3">Transfer Antar Akun</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    ...
                    <span class="mx-3">Persediaan Barang</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                href="#">
                    ...
                    <span class="mx-3">Penyusutan</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    ...
                    <span class="mx-3">Aset Tetap Tak Wujud</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    ...
                    <span class="mx-3">Daftar Amortisasi</span>
                </a>
                <a class="flex items-center  py-2 px-6  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 text-gray-500"
                href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    ...
                    <span class="mx-3">Akun Modal</span>
                </a>

                <p class="py-2 px-6 text-gray-500 text-bold">Data Master</p>
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">Setting</p>

                <a class="flex items-center  py-2 px-6 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/accounting*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' : 'text-gray-500' }}"
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">Report</p>
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">User</p>
                ...
                href="{{ route('back_bisnis') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 9l-3 3m0 0l3 3m-3-3h7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="mx-3">Back to Bisnis</span>
                </a>
            </nav>
        </div>
